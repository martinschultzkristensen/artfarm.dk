...
<main>
    ...
    <div class="container">
      ...
      <div class="row pt-5">
        ...
        <div class="col-lg-10 col-8 align-self-center">
          ...
          <a class="btn btn-outline-dark btn-sm" href="https://www.maitidancecompany.org/" role="button" target="_blank"><img src="https://storage.e.jimdo.com/cdn-cgi/image/quality=85,fit=cover,format=auto,width=32,height=32/image/123693745/a042f6f1-2964-4db3-b284-9ee5f1d990a1.png" height="15" class="d-inline-block align-text-center"> Mai-Ti Dance Company Website &raquo;</a>
        </div>
      </div>
      ...
      <div class="row pt-5">
        <div class="col">
          <img src="/img/team/Lilli.png" class="img-fluid rounded-3 figure-img" alt="Picture of Lilli">
        </div>
        <div class="col-lg-10 col-8 align-self-center">
          <h2>Lilli O'Reilly Wagner Hansen</h2>
          <p class="lead">Danser<br>Performer med os i <a href="/repertoire/danceomatic">danceOmatic</a></p>
          <p>Lilli arbejder som freelance-danser og er bosat i København.</p>
        </div>
      </div>
      <!-- Timothy -->
      <div class="row pt-5">
        <div class="col">
          <img src="/img/team/timothy.png" class="img-fluid rounded-3 figure-img" alt="Picture of Timothy">
        </div>
        <div class="col-lg-10 col-8 align-self-center">
          <h2>Timothy De Mesa</h2>
          <p class="lead">Danser<br>Performer med os i <a href="/repertoire/danceomatic">danceOmatic</a></p>
          <p>Timothy arbejder som freelance-danser og er bosat i København.</p>
        </div>
      </div>
      <!-- Nikoline -->
      <div class="row pt-5">
        <div class="col">
            <img src="/img/team/Nikoline.png" class="img-fluid rounded-3 figure-img" alt="Picture of Nikoline">
        </div>
        <div class="col-lg-10 col-8 align-self-center">
          <h2>Nikoline Due Iversen</h2>
          <p class="lead">Danser<br>Performer med os i <a href="/repertoire/danceomatic">danceOmatic</a></p>
          <p>Nikoline arbejder som freelance-danser og er bosat i København.</p>
        </div>
      </div>
      <div class="row pt-5">
        <div class="col">
    ...
    <div class="col-lg-10 col-8 align-self-center">
      ...
      <p class="lead">Skuespiller<br>Optræder i <a href="/repertoire/akrylarium">AKRYLARIUM</a> og <a href="/co-lab/terminus.php">Terminus</a></p>
      <p>Marco er baseret i Horsens, Danmark og er den kunstneriske leder af Humanlab.</p>
      <a class="btn btn-outline-dark btn-sm" href="https://www.humanlab.studio" role="button" target="_blank"><img src="https://www.humanlab.studio/favicon.ico" height="15" class="d-inline-block align-text-center">HumanLab / theatre company website &raquo;</a>
    </div>
  </div>
