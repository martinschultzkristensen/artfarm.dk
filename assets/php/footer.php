    ...
    <div class="row mx-lg-2">
      <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-md-1 col-4 mt-2">
              <img src="/assets/svg_elements/GHT_BiberBlack.svg" alt="logo Gerhard Haubtmann Theater" class="img-fluid pt-sm-4 px-1">
              <img src="/img/support_logo/hca_hvid_2024_dato-by-år.png" alt="Mai-Ti dance company logo" class="img-fluid pt-3">
            </div>
            <div class="col-md-1 col-3">
              <img src="/img/support_logo/humlabFaceBlack.png" alt="HumanLab logo" class="img-fluid pt-4 px-2">
            </div>
            <div class="col-md-1 col-3">
