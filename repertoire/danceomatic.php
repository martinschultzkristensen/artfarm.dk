      ...
      <div class="container my-5" id="skeleton">
        ...
        <main>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-7 py-5">
              ...
              <a href="/pdf/danceOmatic_expl_da.pdf" class="link-container p-3 border rounded" target="_blank">
                ...
                <div>
                  <h5 class="mb-1 text-with-icon">Beskrivelse i pdf format<object data="/assets/svg_elements/arrow-right-short.svg" id="arrow-right-short" class="bi-arrow-right-short" type="image/svg+xml"></object></h5>
                </div>
              </a>
            </div>
            <div class="col-12">
              <a href="https://teateravisen.dk/tilbud-dance-on-demand/" class="link-container p-3 border rounded" target="_blank">
                ...
                <div>
                  <p class="mb-0">Morten Hede, teaterjournalist og anmelder:</p>
          ...
          <div class="row pt-5 align-items-center">
            <div class="col-md-6">
              <h2 class="featurette-heading">Hér har danceOmatic bragt dans ud!</h2>
              <p class="lead mt-3 mx-3">Gennem årene er danceOmatic blevet præsenteret rundt om i verden, fra pulserende storbyer til fjerntliggende øer. Dermed fastholder vi vores oprindelige vision om at bringe kunst og kultur ud til selv de mest afsidesliggende steder.</p>
            </div>
          </div>
          <div class="row pt-5 align-items-center">
            <div class="col-md-6">
